            ...
            <div>
              ...
              <div className="mt-3 text-xs text-gray-400 flex justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  class=" mt-4 hover:bg-[#1e2749] hover:text-white bg-yellow-400 text-gray-900 px-4 py-2 rounded-md text-sm font-semibold transition  duration-300 ease-in-out"
                >
                  Visit Site ›
                </a>
              </div>
